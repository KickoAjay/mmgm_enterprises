...
function parseProductForm(formData: FormData) {
  return productFormSchema.safeParse({
    ...
    sareeLengthMeters: formData.get("sareeLengthMeters"),
    blousePieceIncluded: formData.get("blousePieceIncluded"),
    blouseLengthMeters: formData.get("blouseLengthMeters"),
    primaryColorId: formData.get("primaryColorId"),
    secondaryColorId: formData.get("secondaryColorId"),
    patternId: formData.get("patternId"),
    design: formData.get("design"),
    borderType: formData.get("borderType"),
    borderColor: formData.get("borderColor"),
    palluType: formData.get("palluType"),
    ...
    returnEligible: formData.get("returnEligible"),
